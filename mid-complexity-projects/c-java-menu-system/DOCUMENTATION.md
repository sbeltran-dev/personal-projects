...
READS USER INPUT
  ↓
DID THE USER ENTERED A VALID INPUT? → NO → SHOWS ERROR → CLEANS BUFFER → SHOWS MENU
  ↓ YES
...
EXERCISE STARTS
  ↓
THE EXERCISE ASKS FOR AN INPUT
  ↓
DOES THE USER WANT TO REPEAT THE EXERCISE? → YES  → ASKS FOR ANOTHER INPUT
  ↓ NO
